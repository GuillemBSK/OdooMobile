...
public class OdooUtility {
     ...
     * @return task id
     ********************************************************************/
    public long search_read(XMLRPCCallback listener, String db, String uid, String password, String object, List conditions, Map<String, List> fields ){
    ...
    public void MessageDialog(Context context, String msg){
        ...
        alertDialogBuilder.setMessage(msg).setCancelable(false).setPositiveButton(android.R.string.ok,
